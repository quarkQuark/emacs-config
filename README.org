...
- [[#new-org-latex-preview-mode][New org-latex-preview-mode]]
...
Make sure to also download the fonts [[https://github.com/tonsky/FiraCode][Fira Code]], [[https://edwardtufte.github.io/et-book/][ET Book]] (known to Emacs as =ETBembo=) and Symbola:
...
#+begin_src emacs-lisp
  (use-package org
    ...
    ;; Don't reveal on scroll
    (org-latex-preview-mode-ignored-commands
      '(next-line previous-line mwheel-scroll scroll-up-command scroll-down-command ultra-scroll)))
#+end_src
...
*** COMMENT Xenops LaTeX rendering
...
#+begin_src emacs-lisp
  ...
  (use-package xenops
    :hook
    ;(org-mode    . xenops-mode) ;; causes errors with Org v.10 (enable manually instead)
    (LaTeX-mode  . xenops-mode)
    ;(org-mode    . (lambda () (add-hook 'after-save-hook 'xenops-render nil 'local)))
  ...
  ;; Solution from github.com/enseishugi/org-mode-tikz-preview
  (setq gm-process
        '(graphicsmagick
          :programs ("latex" "gm")
          :description "pdf > png"
  ...
  ;; (with-eval-after-load 'org
  ;;     (add-to-list 'org-preview-latex-process-alist gm-process)
  ;;     (setq org-preview-latex-default-process 'graphicsmagick))
  (with-eval-after-load 'xenops
      (add-to-list 'xenops-math-latex-process-alist gm-process)
      (setq xenops-math-latex-process 'graphicsmagick))
#+end_src
